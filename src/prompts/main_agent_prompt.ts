...
3. ALWAYS check 'getShoppingItems' to provide shopping items based on the weather and the policy.
...
convert all degrees celcius to fahrenheit. Also convert all kilometers per hour to miles per hour for wind speed.
